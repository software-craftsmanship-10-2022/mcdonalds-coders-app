...
describe('Given a CancelledByUser class', () => {
  ...
  it('when an CancelledByUserState instance is created then nextStep() method should be defined', () => {
    expect(order.getState().nextStep).toBeDefined();
  });

  it('when an CancelledByUserState instance is created then cancelByUser() method should be defined', () => {
    expect(order.getState().cancelByUser).toBeDefined();
  });

  it('when an CancelledByUserState instance is created then cancelByRestaurant() method should be defined', () => {
    expect(order.getState().cancelByRestaurant).toBeDefined();
  });

  it('when an CancelledByUserState instance is created then reject() method should be defined', () => {
